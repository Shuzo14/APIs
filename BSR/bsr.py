...
def bank_statement_read(file_path, bank_name):
    ...
    all_print = '{'+'"statements"'+':'+ str(bankData) +'}'
    sal_print = '{'+'"Salary"'+':'+ str(salary) +'}'
    upi_print = '{'+'"UPI"'+':'+ str(UPI)+'}'
    nach_print = '{'+'"NACH"'+':'+ str(NACH) +'}'
    neft_print = '{'+'"NEFT"'+':'+ str(NEFT) +'}'
    imps_print = '{'+'"IMPS"'+':'+ str(IMPS) +'}'
